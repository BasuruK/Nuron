...
from nuron_ai.extraction import extract_markdown
...
def approve(
    ...
    assert next_version_row is not None  # bare COALESCE(...) aggregate always returns one row
...
def reingest_diff(
    ...
    *,
    ...
    # edits already overwrote the pristine extracted text for the prior version.
